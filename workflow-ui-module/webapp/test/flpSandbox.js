		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#errorworkflowuimodule-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"errorworkflowuimodule-display": {
								"semanticObject": "errorworkflowuimodule",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=error.workflowuimodule",
									"url": sap.ui.require.toUrl("error/workflowuimodule")
								}
							}
						}
					}
